...
if flag:
    ...
    database.insert_reception(1, 2, '2022-12-01', '9:00:00', 'Кашель', 'Анализ крови', 'Простуда',
                              'Муколетики, тепло одеть собаку.')
    database.insert_reception(7, 2, '2022-12-01', '9:30:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(8, 2, '2022-12-01', '10:00:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(9, 2, '2022-12-01', '10:30:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')

    database.insert_reception(1, 3, '2022-12-02', '9:00:00', 'Выписка с ОРЗ', 'Анализ крови', 'Здоров',
                              'На прогулки одевать на животного одежду, гулять не более часа.')
    database.insert_reception(2, 3, '2022-12-02', '9:30:00', 'Кашель', 'Анализ крови', 'Простуда',
                              'Муколетики, тепло одеть собаку.')
    database.insert_reception(3, 3, '2022-12-02', '10:00:00', 'Кошка чешется.', 'Анализ шерсти', 'Блохи',
                              'Помыть кошку с специальным шампунем.')
    database.insert_reception(4, 3, '2022-12-12', '10:30:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(5, 3, '2022-12-02', '11:00:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(6, 3, '2022-12-02', '11:30:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')

    database.insert_reception(2, 4, '2022-12-03', '9:30:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(4, 4, '2022-12-03', '10:00:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(5, 4, '2022-12-03', '10:30:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(6, 4, '2022-12-03', '11:00:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
    database.insert_reception(1, 4, '2022-12-03', '11:30:00', 'Рана на лапе', '', 'Ранение',
                              'Смена повязки каждый день.')
    database.insert_reception(9, 4, '2022-12-03', '12:00:00', 'Текст с описанием',
                              'Текст с диагностическими исследованиями', 'Текст с диагнозом',
                              'Текст с рекомендациями')
